function [ Angrr, xyDist ] = Disorientation_Angle_Hist_Multi( dis, s1, s2, bins, Angrr,  colour, leg)
...
% whos centersrr;
        %figure
        %hold on 
plot(centers, counts/(numel(Ang)*(bins(2)-bins(1))),'-k', 'LineWidth', 1,...
    'Color', colour, 'DisplayName', num2str(leg));% (bins(2) - bins(1))/2
