function [ pos, orientation_array_min, fitTmin, structcode ] = struct_orient_2_PAR( coordinates, NN, refcell, minN, symmineqidxCell)
%NAME: Structure_orient_2_PAR
...
for a = 1:numel(refcell)
    ...
    [orientation_array, fitT] = orientation_5( DataLongCOMP, refa, minN, symmineqidxa);
